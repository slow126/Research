...
sig_c = increase_size_byN(B_C,2) .* sigma_M;
sig_m = increase_size_byN(B_C .* sigma_C,2);

sigma_add = medfilt2(sig_c,[6,6]) - medfilt2(sig_m,[6,6]);
...
% mouth = rad_M(631:656,370:383);
% mouth = (mouth - min(min(mouth)))/(max(max(mouth))-min(min(mouth)));
% make_image(mouth',10);
% figure(11)
% imhist(mouth);
% 
% mouth = filt(631:656,370:383);
% mouth = (mouth - min(min(mouth)))/(max(max(mouth))-min(min(mouth)));
% make_image(mouth',12);
% figure(13)
% imhist(mouth);
% 
% mouth = rad_M_truth(631:656,370:383);
% mouth = (mouth - min(min(mouth)))/(max(max(mouth))-min(min(mouth)));
% make_image(mouth',14);
% figure(15)
% imhist(mouth);
