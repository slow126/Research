...
function [Timefreq, f_r, t_r] = myspecgram(x, n, Fs, window, overlap)
  ...
  inst = 'y';%input('Do you want to see a spectrogram of this STFT (y/n)?', 's');
  ...
  maxfreq = Fs/2;%input('Please enter the maximum frequency (Hz)\n you wish to see on the display:');
...
inst = 'y';%input('How about a snazzy 3-D color spectrogram (y/n)','s');
