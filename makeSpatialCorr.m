...
% small_eps = small_eps - nanmean(nanmean(small_eps));
% small_sigma = small_sigma - nanmean(nanmean(small_sigma));
...
save('spatialT_test.mat','corr_img');

get_atY = 1250;
get_atX = 400;

eps_square = small_eps(index.minus_y(get_atY):index.plus_y(get_atY),index.minus_x(get_atX):index.plus_x(get_atX));
sig_square = small_sigma(index.minus_y(get_atY):index.plus_y(get_atY),index.minus_x(get_atX):index.plus_x(get_atX));
