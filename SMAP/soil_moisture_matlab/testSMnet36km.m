...
year=2016;
days=[2];
res=3; % 1=3km Sentinel/SMAP ancillary, 2=9km SMAP ancillary, 3=36km SMAP ancillary
...
for dayidx=1:length(days)
    ...
    if(whichones==1)
        moisture_map1(moisture_map1>0.5) = 0.5;
        moisture_map2(moisture_map2>0.5) = 0.5;
        moisture_map3(moisture_map3>0.5) = 0.5;
        moisture_map4(moisture_map4>0.5) = 0.5;
        moisture_map5(moisture_map5>0.5) = 0.5;
        moisture_map6(moisture_map6>0.5) = 0.5;
        moisture_map1(moisture_map1<0.02) = 0.02;
        moisture_map2(moisture_map2<0.02) = 0.02;
        moisture_map3(moisture_map3<0.02) = 0.02;
        moisture_map4(moisture_map4<0.02) = 0.02;
        moisture_map5(moisture_map5<0.02) = 0.02;
        moisture_map6(moisture_map6<0.02) = 0.02;
    elseif(whichones==2)
        moisture_map7(moisture_map7>0.5) = 0.5;
        moisture_map8(moisture_map8>0.5) = 0.5;
        moisture_map9(moisture_map9>0.5) = 0.5;
        moisture_map10(moisture_map10>0.5) = 0.5;
        moisture_map11(moisture_map11>0.5) = 0.5;
        moisture_map12(moisture_map12>0.5) = 0.5;
        moisture_map7(moisture_map7<0.02) = 0.02;
        moisture_map8(moisture_map8<0.02) = 0.02;
        moisture_map9(moisture_map9<0.02) = 0.02;
        moisture_map10(moisture_map10<0.02) = 0.02;
        moisture_map11(moisture_map11<0.02) = 0.02;
        moisture_map12(moisture_map12<0.02) = 0.02;
    end
    ...
    if(whichones==1)
        error1=smav(1:nsy1,1:nsx1)-moisture_map1;
        error2=smav(1:nsy1,1:nsx1)-moisture_map2;
        error3=smav(1:nsy1,1:nsx1)-moisture_map3;
        error4=smav(1:nsy1,1:nsx1)-moisture_map4;
        error5=smav(1:nsy1,1:nsx1)-moisture_map5;
        error6=smav(1:nsy1,1:nsx1)-moisture_map6;
    ...
    elseif(whichones==2)
        error7=smav(1:nsy1,1:nsx1)-moisture_map7;
        error8=smav(1:nsy1,1:nsx1)-moisture_map8;
        error9=smav(1:nsy1,1:nsx1)-moisture_map9;
        error10=smav(1:nsy1,1:nsx1)-moisture_map10;
        error11=smav(1:nsy1,1:nsx1)-moisture_map11;
        error12=smav(1:nsy1,1:nsx1)-moisture_map12;
    ...
    if mapplot
        ...
        imagesc(smavplot,[0.02 0.5]);
        title('NSIDC SM');
        colormap jet(128);
        colorbar
        
        figure
        imagesc(abs(error5),[0 0.5]);
        title('Error Map');
        colormap jet(128);
        colorbar
    end
